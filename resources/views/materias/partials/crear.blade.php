...
<form class="form-horizontal" id="crear" action="{{route('locales.store')}}" method="POST">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-8">
        <input class="form-control col-md-8 {{$errors->has('codigo')?'is-invalid':''}}" type="email" name='codigo' placeholder="Ingresar codigo del local" value="{{ old('codigo')}}">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-8">
            <input class="form-control col-md-8 {{$errors->has('tipo')?'is-invalid':''}}" type='text' name="tipo" placeholder="Ingresar titulo academico" value="{{ old('tipo')}}">
