  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <li><a class="app-menu__item {{isActive('inicio')}}" href="{{route('home')}}"><i class="app-menu__icon fa fa-dashboard "></i><span class="app-menu__label">Dashboard</span></a></li>
        ...
        <li><a class="app-menu__item {{isActive('inicio')}}" href="{{route('home')}}"><i class="app-menu__icon fa fa-building-o "></i><span class="app-menu__label">Planificación de ciclo</span></a></li>
